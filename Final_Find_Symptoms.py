...
def diseasePredict(user_input):
    import re
    import numpy as np
    import pandas as pd
    from stemmer import Stemmer
    data = pd.read_excel ("Gujarati_Dimensionality_Reduction.xlsx",engine='openpyxl')
    ...
    if input_text.startswith(s1): 
        ...
        outputs.append(symptoms) 
        outputs.append(max_n)
    ...
    if flag == 0:
        ...
        data2 = pd.read_excel ("Gujarati_Dataset2.xlsx",engine='openpyxl')
